...
public class Usuario implements Serializable {
    ...
    public Collection<RutaProcesada> getRutaProcesadaCollection() {
        return rutaProcesadaCollection;
    }

    public void setRutaProcesadaCollection(Collection<RutaProcesada> rutaProcesadaCollection) {
